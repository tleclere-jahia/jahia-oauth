...
<%--@elvariable id="url" type="org.jahia.services.render.URLGenerator"--%>
    ...
    <template:addResources type="css" resources="joaFacebookButton.unified.css"/>
    ...
    <c:choose>
        <c:when test="${tagType eq 'button'}">
            <button class="facebook-btn custom-btn-theme ${cssClass}" type="button"
