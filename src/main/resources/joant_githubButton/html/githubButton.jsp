...
<%--@elvariable id="url" type="org.jahia.services.render.URLGenerator"--%>
    ...
    <template:addResources type="css" resources="joaGithubButton.css"/>
    ...
    <c:choose>
        <c:when test="${tagType eq 'button'}">
            <c:choose>
                <c:when test="${currentNode.properties['buttonColor'].string eq 'light'}">
                    <!-- Light -->
                    <button class="github-btn-light ${cssClass}"
                ...
                <c:otherwise>
                    <!-- Dark -->
                    <button class="github-btn-dark ${cssClass}"
                            <c:if test="${not renderContext.editMode}"> onclick="connectToGithub${fn:replace(currentNode.identifier, '-', '')}()" </c:if>
                            <c:if test="${not empty htmlId}"> id="${htmlId}"</c:if>
                            <c:if test="${renderContext.editMode}">disabled</c:if> >
        ...
        <c:otherwise>
            <c:choose>
                <c:when test="${currentNode.properties['buttonColor'].string eq 'light'}">
                    <!-- Light -->
                    <a class="github-btn-light ${cssClass}" href="#"
                ...
                <c:otherwise>
                    <!-- Dark -->
                    <a class="github-btn-dark ${cssClass}" href="#"
